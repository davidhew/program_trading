    ...
    for batch in usa_gd.get_stock_data_batches():
        ...
        for stock_df in batch:
            ...
            if (len(stock_df) < 253):
                ...
                # 需要MA200趋势向上
                if (not stock_df.iloc[row_idx]['MA200'] >= stock_df.iloc[row_idx - 1]['MA200']):
                    continue
                # 需要MA50在MA200之上
                today_50_up_MA_200 = stock_df.iloc[row_idx]['MA50'] >= stock_df.iloc[row_idx]['MA200']

                last_day_50_below_MA_200= (stock_df.iloc[row_idx-1]['MA50']<=stock_df.iloc[row_idx-1]['MA200'])

                cross_MA_200= last_day_50_below_MA_200 and today_50_up_MA_200
